...
```{r exampleDataPane1, echo = F, out.width = "75%", fig.cap = "Landing page for tinselR with 'Example Data' tab highlighted in blue."}
knitr::include_graphics("Slide1.SVG")
```

```{r exampleDataPane2, echo = F, out.width = "75%", fig.cap = "'Example Data' tab with available tree visual parameters highlighted within the blue box."}
knitr::include_graphics("Slide2.SVG")
```
...
```{r exampleDataPane3, echo = F, out.width = "75%", fig.cap = "Pre-loaded example dataset 1 is selected and can be seen once the user presses the 'Visaulize Tree' button."}
knitr::include_graphics("Slide3.SVG")
```
...
knitr::include_graphics("Slide4.SVG")
```

```{r exampleDataPane5, echo = F, out.width = "75%", fig.cap = "With tips of interest highlighted, pressing the 'Add Annotations' button will add annotations to the tree image, which indicate the range and median of SNPs for these tips of interest. The tree with annotations is within the larger blue box, while the buttons for adding annotations is in the smaller box on the left of image. "}
knitr::include_graphics("Slide5.SVG")
```

**Including metadata for tip correction and heatmap**

Figure \@ref(fig:exampleDataPaneMeta) provides an example metadata file with 
...
image either with or without annotations (Figure \@ref(fig:exampleDataPane6)). 


```{r exampleDataPaneMeta, echo = F, out.width = "50%", fig.cap = "Example metadata 1 with the third column highlighted in blue indicating information used for adding a heatmap. "}
knitr::include_graphics("metaDataExample.PNG")
```

```{r exampleDataPane6, echo = F, out.width = "100%", fig.cap = "Tree image with annotations and a heatmap of collection source displayed within blue box. The add heatmap is also within the blue box on the left of the image."}
knitr::include_graphics("Slide6.SVG")
```
...
```{r exampleDataPane7, echo = F, out.width = "100%", fig.cap = "**Tree image with annotations and a heatmap of collection source displayed. The download image options is within the blue box on the bottom of the image.**"}
knitr::include_graphics("Slide7.SVG")
```
...
knitr::include_graphics("Slide8.SVG")
```
...
headers (Tip.labels, and Display.labels; Figure \@ref(fig:exampleDataPaneMeta)),
...
knitr::include_graphics("geneDistanceExample.PNG")
```

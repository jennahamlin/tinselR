...
```{r exampleDataPane1, echo = F, out.width = "85%", fig.cap = "Example data pane is circled in blue"}
knitr::include_graphics(here::here("vignettes/images/slide1.png"))
```


```{r exampleDataPane2, echo = F, out.width = "85%", fig.cap = "Pre-loaded example dataset 3 is selected for all three data uploads subsections "}
...
```{r exampleDataPane3, echo = F, out.width = "85%", fig.cap = "Example data pane with tree visual parameters circled in blue."}
knitr::include_graphics(here::here("vignettes/images/slide3.png"))
```

```{r exampleDataPane4, echo = F, out.width = "85%", fig.cap = "Pressing 'Visualize Tree' button will allow the tree to be viewed on screen. "}
knitr::include_graphics(here::here("vignettes/images/slide4.png"))
```

```{r exampleDataPane5, echo = F, out.width = "85%", fig.cap = "Within tips of interested highlight, pressing the 'Add Annotations' button will add annotations to the tree image which indicate the range of snps found for these tips of interest. "}
...
```{r exampleDataPane6, echo = F, out.width = "85%", fig.cap = "Example meta data 3 with the third column highlighted in blue indicating information used for adding a heatmap. "}
knitr::include_graphics(here::here("vignettes/images/slide6.png"))
```

```{r exampleDataPane7, echo = F, out.width = "85%", fig.cap = "Tree image with annotations and a heatmap of collection source with the donwload image section highlight in below and the add/remove heatmap also highlighted in blue."}

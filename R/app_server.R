...
app_server <- function(input, output,session) {
  ...
  tipCheckOut <- callModule(mod_tipCheck_server, "tipCheck_ui_1", dataDisplay$metaFileOut,  dataDisplay$geneFileTipCheckOut, dataDisplay$metaSep, dataDisplay$geneSep)

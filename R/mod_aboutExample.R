    ...
    fluidRow(column(12, offset = 0,
                    mainPanel(h2(strong("Description of Example Data")),
                              ...
                              tags$p((tags$h5(tags$strong("Data set 1"))),
                                     ...
                                     button. If the example gene data set is
                                     also uploaded then the user can add/remove
                                     annotations. This dataset does not have
                                     metadata for adding the heatmap. ",
                              ...
                              tags$p((tags$h5(tags$strong("Data set 2"))),
                                     ...
                                     0.09. While the metadata does have 
                                     extra columns, this dataset has greater
                                     than one column in the meta data file. If
                                     the user presses the add heatmap then a
                                     heatmap will be displayed but it will not
                                     be informative.",
                              ...
                              tags$p((tags$h5(tags$strong("Data set 3"))),
                                     ...
                                     column in the metadata. If you press 'Add
                                     Heatmap' make sure to adjust the position
                                     of the heatmap to be less than the spacing
                                     on the plot. Both of these options are 
                                     located in the alter tree parameters box.",

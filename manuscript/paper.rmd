...
header-includes:
  ...
  - \usepackage{parskip} #skip identation of paragraphs
  - \usepackage[left]{lineno} #line number package
  - \linenumbers #add line numbers to the pages
...
of the metadata file is to relabel the tips on the tree image. The header ofthe
...
example data sets was generated and used under the CDC IRB protocol 7172. After
